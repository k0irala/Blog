    ...
    <div className="min-h-screen bg-background">
      ...
      <div className=" mx-auto  py-12 md:py-16 bg-[#111318]">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <Card className="p-8 border-gaming-border bg-card/50 backdrop-blur-sm hover:border-red-500 duration-600 ease-in-out">
            ...
            <div className="mt-6 pt-6 border-t border-border">
              <p className="text-sm text-muted-foreground">
                <span className="font-semibold text-foreground">Sources:</span> <a href="https://en.wikipedia.org/wiki/Valorant" className="text-red-500 hover:underline">Wikipedia</a>, <a href="https://playvalorant.com/en-us/" className="text-red-500 hover:underline">PlayValorant.com</a>, <a href="https://www.redbull.com/us-en/what-is-valorant-beginner-guide" className="text-red-500 hover:underline">Red Bull Guide</a>
              </p>
            </div>
          </Card>
          ...
          <Card className="p-8 border-gaming-border bg-card/50 backdrop-blur-sm hover:border-red-500 duration-600 ease-in-out">
            ...
            <div className="mt-6 pt-6 border-t border-border">
              <p className="text-sm text-muted-foreground">
                <span className="font-semibold text-foreground">Sources:</span> <a href="https://en.wikipedia.org/wiki/Valorant" className="text-red-500 hover:underline">Wikipedia</a>, <a href="https://playvalorant.com/en-us/news/announcements/beginners-guide/" className="text-red-500 hover:underline">Beginner's Guide</a>, <a href="https://www.redbull.com/us-en/what-is-valorant-beginner-guide" className="text-red-500 hover:underline">Red Bull Guide</a>
              </p>
            </div>
          </Card>
